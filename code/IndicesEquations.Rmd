...
$$FE = {1\over T} \int_{0}^T \int_{0}^{X_{max}} \sqrt{u(x,t) \, h(x,t)} \, dx\,dt$$
...
```{r}
require(bio3d)
  BhattacharyyaDCoefficient <- function(i1, i2){
    BC <- bhattacharyya(cov(i1), cov(i2)) #do we need a q value? 
    list(BC)
  } #does this function take the mean of the BC over the year? 
```
